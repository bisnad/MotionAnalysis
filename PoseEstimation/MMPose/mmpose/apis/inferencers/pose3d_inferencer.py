...
class Pose3DInferencer(BaseMMPoseInferencer):
    ...
    def __init__(self,
        ...
        #print("Pose3DInferencer model ", model, " weights ", weights, " pose2d_model ", pose2d_model, " pose2d_weights ", pose2d_weights)
    ...
    def preprocess_single(self,
        ...
        #print("pose3d inferencer preprocess_single begin")
        ...
        #print("pose3d inferencer preprocess_single end")
    ...
    def forward(self,
        ...
        #print("pose3d inferencer forward begin ")
        ...
        #print("pose3d inferencer forward end ")
