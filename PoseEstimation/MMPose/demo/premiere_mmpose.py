...
motion_model.config["init_args"] = init_args
motion_model.config["call_args"] = call_args

model = motion_model.MotionModel(motion_model.config)
...
motion_gui.config["motion_model"] = model
