/** \file dab_data_proc_derivative_euler.cpp
*/
...
DataProcDerivativeEuler::DataProcDerivativeEuler()
	: DataProc()
{}

DataProcDerivativeEuler::DataProcDerivativeEuler(const std::string& pName, const std::string& pDerivDataName)
	: DataProc(pName)
...
void
DataProcDerivativeEuler::process() throw (dab::Exception)
{
	...
	for (int i = 0; i < arraySize; ++i)
	{
		...
		valuesDeriv[i] = std::fmod(valuesDeriv[i], glm::pi<float>());
