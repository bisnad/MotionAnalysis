...
# Pre-computed feature size (22 joints * 12 features per joint [rot(4)+vel_rot(4)+acc_rot(4)])
num_features = len(mocap_joint_indices) * 12
...
save_stats_path = "../MocapClassifier/results_Yurika_Mediapipe_nopos_30_v3/stats"
model_weights_file = "../MocapClassifier/results_Yurika_Mediapipe_nopos_30_v3/weights/classifier_weights_epoch_200.pth"
