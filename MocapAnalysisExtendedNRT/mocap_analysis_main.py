"""
compute motion features for a single mocap file 
and export these features as python dictionary

the motion features correspond more or less to those described in the papers:
    http://www.andreasaristidou.com/publications/papers/Emotion_Analysis_and_Classification.pdf
    http://www.andreasaristidou.com/publications/papers/Emotion_Control_of_Unstructured_Dance_Movements.pdf
...
mocap_data_path = "D:/Data/mocap/stocos/xsens/Canal_14-08-2023/bvh/Canal_14-08-2023-004_Muriel_staccato_full_body.bvh"
mocap_joint_weights_path = "configs/joint_weights_xsens_bvh.json"
mocap_fps = 50

"""
mocap feature settings
"""

# output file containing features
feature_data_path = "results/motion_features/Canal_14-08-2023-004_Muriel_staccato_full_body_features.npy"
...
np.save(feature_data_path, mocap_features) 
